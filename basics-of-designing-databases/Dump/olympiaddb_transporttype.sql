...
CREATE TABLE `transporttype` (
  ...
  `typeName` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  PRIMARY KEY (`typeId`)
...
INSERT INTO `transporttype` VALUES (1,'электропоезд'),(2,'автобус'),(3,'трамвай'),(4,'троллейбус'),(5,'маршрутное такси');
