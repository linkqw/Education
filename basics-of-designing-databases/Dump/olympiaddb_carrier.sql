...
CREATE TABLE `carrier` (
  ...
  `carrierName` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
INSERT INTO `carrier` VALUES (1,'ПАТП-4'),(2,'РЖД'),(3,'ПАТП-1'),(4,'ПАТП-3'),(5,'Энергия'),(6,'Абсолют');
